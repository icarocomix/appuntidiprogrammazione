...
sintesi: "La metrica più onesta per misurare una query non è il tempo (che dipende dal carico del server), ma i blocchi letti (BUFFERS). La differenza tra share..."
tech: db
