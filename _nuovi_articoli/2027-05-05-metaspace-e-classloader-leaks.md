...
* Identifico i ClassLoader che non vengono scaricati tramite heap dump e analisi * con Eclipse MAT: */   // jcmd <PID> GC.heap_dump filename=heap.hprof
// In MAT: Leak Suspects > "One instance of ClassLoader holds N classes"
* La causa più comune in Spring Boot è la creazione ripetuta di * ApplicationContext in test o l'uso di Groovy/scripting che compila nuove
