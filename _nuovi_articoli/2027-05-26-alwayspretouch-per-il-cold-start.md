...
```java
* Forzo l'allocazione fisica immediata di tutto l'heap dichiarato. Con -Xms = * -Xmx e AlwaysPreTouch, la JVM scrive un byte in ogni pagina da 4KB dell'heap
...
sensitive-app.jar
/* Misuro l'impatto sul tempo di avvio prima e dopo: */   // Senza AlwaysPreTouch: avvio in 3.2s, prima richiesta in 45ms, p99 prime 100
// richieste: 320ms
// Con AlwaysPreTouch: avvio in 8.1s, prima richiesta in 8ms, p99 prime 100
// richieste: 12ms
* In Kubernetes, AlwaysPreTouch interagisce con i readinessProbe: devo * assicurarmi che il probe non scatti prima che il PreTouch sia completato, * altrimenti K8s riceve traffico su un pod non ancora "caldo". */   // readinessProbe:
// httpGet:
...
// periodSeconds: 5
* In Spring Boot, posso segnalare esplicitamente la readiness solo dopo che * l'applicazione è davvero pronta, includendo un warm-up delle cache: */
