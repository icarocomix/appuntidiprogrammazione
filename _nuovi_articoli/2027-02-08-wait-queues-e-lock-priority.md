...
;
        ...
        -- Se arrivo qui, il lock è stato acquisito e l'
ALTER è riuscito EXCEPTION
        WHEN lock_not_available THEN attempt := attempt + 1
;
...
;
        ...
        RAISE NOTICE 'Tentativo % fallito, aspetto 5 secondi...',
        attempt
;
