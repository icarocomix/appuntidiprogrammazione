...
SELECT application_name, pg_wal_lsn_diff(pg_current_wal_lsn(), sent_lsn)
        AS
        network_lag_bytes, pg_wal_lsn_diff(sent_lsn, write_lsn)
        AS write_lag_bytes,
...
;
        ...
        ELSE RAISE NOTICE 'Replica allineata: % MB. Deploy autorizzato.',
        lag_mb
;
