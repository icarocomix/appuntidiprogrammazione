...
```js
* Template Literal Types: combino tipi stringa letterali per generare nuovi * tipi. */  type Entity = 'user' | 'order' | 'product' | 'invoice';
...
class TypedEventEmitter
{
    ...
    {
        'margin-top': '16px',  // OK 'padding-left': '1rem',
