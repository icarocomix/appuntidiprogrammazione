...
```sql
        ...
        * INSERT/
UPDATE/DELETE ma non i
SELECT degli altri utenti, minimizzando
...
INSERT INTO user_rankings (user_id, score, rank)
SELECT
        user_id, sum(points)
        AS score, rank() OVER (
...
;
        ...
        * SHARE -> ROW SHARE -> ROW EXCLUSIVE -> SHARE
UPDATE EXCLUSIVE -> SHARE ->
