...
* vengono eseguite una volta sola durante la build dell'immagine Docker. */   * FASE 1: eseguo l'app una volta per registrare le classi caricate durante lo
* startup. */
...
// business logic
/* FASE 2: creo l'archivio condiviso a partire dalla lista delle classi. */   // java -Xshare:dump \
...
ms", startupMs);
    ...
    // "app.jar"]
    * Per Spring Boot 3.3+, uso il supporto nativo CDS integrato che automatizza le * fasi 1 e 2: */   // ./mvnw spring-boot:process-aot
