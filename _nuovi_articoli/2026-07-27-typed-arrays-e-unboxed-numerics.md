...
// new Array(1_000_000); for (let i = 0; i < standardArray.length; i++)
{
    ...
    // Float64Array(1_000_000); for (let i = 0; i < typedArray.length; i++)
    {
        ...
        // 0; for (let i = 0; i < typedArray.length; i++)
        {
            ...
            * Implemento un equalizzatore audio con Typed Arrays per elaborazione real-time: * */  class AudioEqualizer
            {
                constructor(sampleRate, bufferSize)
                {
                    ...
                    applyEq(inputData)
                    {
                        ...
                        * Per la manipolazione di pixel con Canvas API, uso Uint8ClampedArray tramite * ImageData: */  function applyBrightnessFilter(canvas, brightness)
                        {
                            ...
                            const sharedBuffer = new SharedArrayBuffer(Float64Array.BYTES_PER_ELEMENT * 1_000_000);
