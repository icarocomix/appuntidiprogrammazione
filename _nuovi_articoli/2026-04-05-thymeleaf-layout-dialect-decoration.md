...
// www.ultraq.net.nz/thymeleaf/layout">
    <head>
        <!-- layout:title-pattern combina
// il titolo della pagina con il nome del sito -->
        <title layout:title-
// pattern="$CONTENT_TITLE | MyApp">
            MyApp
        </title>
        <!-- Meta-tag SEO di default:
// sovrascrivibili dalla pagina -->
...
">
        ...
        <nav
layout:fragment="breadcrumb" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li
class="breadcrumb-item">
        ...
        <!-- Contenuto principale: DEVE
essere sovrascrivitto dalla pagina figlia -->
...
<!-- Decora il base layout aggiungendo
sidebar e stili admin -->
<html xmlns:layout="http:
...
">
    <head>
        ...
        <!-- Aggiunge CSS admin al blocco page-css del
base layout -->
...
">
                ...
                <!-- Sotto-frammento: le pagine admin riempiono questo slot -->
                <main
layout:fragment="admin-content">
                    <p>
...
<!-- Decora il layout admin, non il base:
eredita l'intera gerarchia -->
<html xmlns:layout="http:
//www.ultraq.net.nz/thymeleaf/layout" layout:decorate="~
{layouts/admin}
">
