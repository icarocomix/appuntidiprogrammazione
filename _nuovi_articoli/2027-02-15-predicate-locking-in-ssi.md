...
```sql
        ...
        * implicito sulla condizione
    WHERE project_id = 5. Se qualcuno inserisce una
...
INSERT INTO expenses
    ...
    VALUES (5, 100, 'Acquisto hardware')
;
...
SELECT database, relation::regclass, mode, pid
    FROM pg_locks
    WHERE locktype IN
        ('relation', 'page', 'tuple', 'object', 'advisory')
