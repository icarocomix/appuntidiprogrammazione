...
```sql
        ...
        * rallentando l'intero cluster. DO $$ DECLARE r RECORD
;

        BEGIN FOR r IN
SELECT *
        *
    FROM staging_table LOOP BEGIN
...
;
        ...
        -- Questo crea una subtransazione per ogni
        * riga! END
;
...
;
        ...
        */
        * PATTERN CORRETTO: elimino la necessità di subtransazioni usando
    ON CONFLICT,
