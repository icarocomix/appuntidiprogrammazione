...
// Es: "sales-chart", "user-stats", "alert-banner" String title, Map
    <String,
// Object>
        params
...
{ public List
        <WidgetConfig>
            getWidgetsForUser(String username) 
{ List
            <UserWidget>
...
esiste, Thymeleaf lancia un errore: gestisco con th:if preventivo. -->
                                <div
th:if="$
