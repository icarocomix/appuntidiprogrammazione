...
;
        ...
        * attese sospette prima che degenerino in deadlock. log_lock_waits =
    on
...
;
        ...
        -- poi aggiorna id=1 Nel log troverò: ERROR: deadlock
        * detected DETAIL: Process 1234 waits for ShareLock
    on transaction 5678
;

        blocked
        * by process 9012. Process 9012 waits for ShareLock
    on transaction 5678
;
        ...
        * stesso ordine, es. sempre per id crescente:
UPDATE accounts
    SET balance =
        * balance + delta
